...
const Home = () => {
  ...
  return (
    <div style={{ background: "linear-gradient(0deg, rgba(0,0,0,1) 100%, rgba(128,128,128,1) 30%, rgba(255,255,255,1) 50%, rgba(138,138,138,1) 40%, rgba(0,0,0,1) 100%)" }} className='pb-5'>
