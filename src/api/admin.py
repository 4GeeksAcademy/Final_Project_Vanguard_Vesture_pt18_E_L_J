...
from .models import db, User, Product, Order, Category, OrderItem, ProductSizeStock, Size, ProductsRating, ShoppingCart, ProductImage , AppImage
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(AppImage, db.session))
